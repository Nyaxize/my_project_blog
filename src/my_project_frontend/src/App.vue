...
async function handleSubmit(e) {
  ...
  console.log("Title:", title); // Debuguj tytuł
  console.log("Content:", content); // Debuguj treść
  console.log("Tag", tags );
  try {
    await my_project_backend.add_blog(title, content, tags); // Upewnij się, że argumenty są poprawne
    console.log("Blog został dodany!");
    await getBlogs();
  } catch (error) {
    console.error("Błąd podczas dodawania bloga:", error);
  }
}
